...
void ex10_run() {
    ...
    setNumberOnClock(second / 5);    // Update the seconds LED
    setNumberOnClock(minute / 5);    // Update the minutes LED
    setNumberOnClock(hour % 12);     // Update the hours LED (12-hour format)
}
